/**
 * @module InterestModel
 * 
 * This module defines the Mongoose schema and model for interest.
 * 
 */
...
const schemaRules = {
  name: {
    ...
    maxlength: [70, "Interest name must be no longer than 70 characers"],
  },
  icon: {
    type: String,
    default: null
...
ModelSchema.index({ name: 1 }, { unique: true, name: "unique_interest_name", collation: { locale: "en", strength: 2 } });
// Compound index for efficient filtering of active documents
ModelSchema.index({ enabled: 1, name: 1 }, { name: "idx_interest_enabled_name" });
